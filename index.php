...
<div class="position-relative overflow-hidden p-3 p-md-5 m-md-3 text-center bg-light">
    ...
    <div class="col-md-5 p-lg-5 mx-auto my-5">
      <center>
      <img src="OIP.jpeg" alt="" width="40%" height="40%">
</center>
      <h1 class="display-4 fw-normal">سجل و اربح </h1>
      <p class="lead fw-normal">باقي على فتح التسجيل</p>
      <h5 id="countdown"></h5>
      <p class="lead fw-normal">أدخل معلوماتك لفرصة الربح معنا بجائزة قيمة!</p>
  ...
  <li class="list-group-item">ان يكون طالب بالكلية التقنية</li>
  <li class="list-group-item">ان يكون العمر من 18 سنة</li>
  <li class="list-group-item">ان يكون متابع لحسابات الكلية</li>
</ul>
  </div>
